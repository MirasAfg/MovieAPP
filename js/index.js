const API_KEY = "41030e52-0baa-45bf-bf91-114f81e19f78";
...
function showMovies(data) {
  ...
  data.films.forEach((movie) => {
    ...
    movieEl.innerHTML = `<div class="movie_cover-inner">
        <img
          src="${movie.posterUrlPreview}"
          class="movie_cover"
          alt="${movie.nameRu}."
        />
        <div class="movie_shadow"></div>
        <div class="movie_info">
          ...
          <div class="movie_category">${movie.genres.map(
            ...
            ${
              movie.rating &&
              `
            <div class="movie_avarage movie_avarage--${getClassByRate(
              movie.rating
            )}">${movie.rating}</div>
            `
            }
